				...
				<table>
					<tr>
						...
						<td><input type="email" id="userid" name="userid"
							value="${member.memberid}" readonly> <input type="text"
							name="idx" value="${member.idx}"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><img height="40" alt="현재 프로필 사진"
							src="<c:url value="/fileupload/member/${member.memberphoto}" />">
							<input type="text" id="oldPhoto" name="oldPhoto"
							value="${member.memberphoto}"></td>
					</tr>
					<tr>
